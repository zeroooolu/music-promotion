(()=>{
  ...
  const active=file==='album-list.html'?'albums':file==='royalty-withdrawal.html'?'royalty':file==='creative-services.html'?'creative':'promotion';
  const nav=[
    ...
    ['creative','creative-services.html','<path d="M5 19.2 6.2 14 16.9 3.3a1.8 1.8 0 0 1 2.5 0l1.3 1.3a1.8 1.8 0 0 1 0 2.5L10 17.8 5 19.2Z" fill="currentColor"/><path d="m14.8 5.4 3.8 3.8" stroke="#fff" stroke-width="1.5" stroke-linecap="round"/><path d="M4 21h16" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/>','创作服务'],
