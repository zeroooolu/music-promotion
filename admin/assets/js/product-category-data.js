...
window.PRODUCT_CATEGORIES = [
  {
    ...
    products: 5, plans: 53, sort: 10, status: 'on', updated: '2026-08-27 15:10'
  },
  {
    id: 'playlist',
    goalId: 'playlist',
    ...
    products: 5, plans: 14, sort: 20, status: 'on', updated: '2026-08-27 15:10'
  },
  {
    id: 'content',
    goalId: 'social',
    ...
    products: 2, plans: 11, sort: 30, status: 'on', updated: '2026-08-27 15:10'
  },
  {
    id: 'overseas',
    goalId: 'global',
    ...
    products: 2, plans: 2, sort: 40, status: 'on', updated: '2026-08-27 15:10'
  },
  {
    id: 'chart-promotion',
    goalId: 'chart',
    ...
    descriptions: {
      zhCN: 'QQ音乐、网易云音乐、酷狗音乐等官方私人歌单打榜及榜单冲刺服务。',
      en: 'Official private-playlist chart campaigns and chart-push services for QQ Music, NetEase Cloud Music, Kugou Music and other platforms.',
      ja: 'QQ Music、NetEase Cloud Music、Kugou Music などの公式プライベートプレイリストを活用したチャート施策・ランキングプロモーション。',
      zhTW: 'QQ音樂、網易雲音樂、酷狗音樂等官方私人歌單打榜及榜單衝刺服務。'
    },
    products: 3, plans: 9, sort: 50, status: 'on', updated: '2026-08-27 15:10'
  },
  {
    ...
    products: 1, plans: 1, sort: 55, status: 'on', updated: '2026-08-27 15:10'
  },
  {
    id: 'scene-service',
    goalId: 'ktv',
    ...
    products: 1, plans: 1, sort: 60, status: 'on', updated: '2026-08-27 15:10'
  }
];
